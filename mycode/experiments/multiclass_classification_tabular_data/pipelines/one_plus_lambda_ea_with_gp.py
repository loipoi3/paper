...
def run_one_plus_lambda_ea_with_gp(x_train: np.ndarray, x_test: np.ndarray, y_train: np.ndarray, y_test: np.ndarray,
                                   args: Any) -> None:
    """
    Train a (1 + lambda) EA with GP model for multiclass classification on tabular data.
    ...
    """
    print("(1 + lambda) - EA with GP for the problem of multiclass classification of tabular data:")
