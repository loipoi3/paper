...
def run_one_plus_lambda_ea_with_gp(x: np.ndarray, y: np.ndarray, args) -> None:
    ...
    print(
        "Results (train loss list, test loss list, time list) are saved in the file: mycode/results/binary_classification_tabular_data/one_plus_lambda_ea_with_gp.json")
